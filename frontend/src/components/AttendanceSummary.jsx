...
const AttendanceSummary = () => {
  ...
  const API_URL = `${(import.meta.env.VITE_API_URL && import.meta.env.VITE_API_URL !== "undefined") ? import.meta.env.VITE_API_URL : "https://digital-whiteboard-2-1.onrender.com"}/api` || "const API = import.meta.env.VITE_API_URL;/api";
