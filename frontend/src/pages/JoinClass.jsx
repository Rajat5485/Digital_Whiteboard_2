...
export default function JoinClass() {
  ...
  useEffect(() => {
    const fetchClassInfo = async () => {
      ...
      try {
        const res = await fetch(`${(import.meta.env.VITE_API_URL && import.meta.env.VITE_API_URL !== "undefined") ? import.meta.env.VITE_API_URL : "https://digital-whiteboard-2-1.onrender.com"}/api/classrooms/${classId}`, {
          headers: {
